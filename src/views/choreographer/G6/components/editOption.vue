<template>
  ...
  >
    ...
    <el-form :model="optionForm" :rules="rules" ref="optionFormRef" label-width="120px" class="form-content">
...
<!--      <el-form-item>-->
<!--        <el-checkbox :true-label="EBoolean.yes" :false-label="EBoolean.no" v-model="optionForm.free"> {{ '免费' }}</el-checkbox>-->
<!--      </el-form-item>-->
<!--      <el-form-item :label="'金币'" v-if="optionForm.free === EBoolean.no">-->
<!--        <el-select v-model="optionForm.coin" placeholder="请选择">-->
<!--          <el-option-->
